...
/// <summary>
/// A 'naive' implementation of NaiveSpan based on Stephen Toub's dotnet deep dive video on NaiveSpan
/// This naiveSpan implementation is purely for demo purposes and for learning
...
/// </summary>
public readonly ref struct NaiveSpan<T> where T : unmanaged {
	public NaiveSpan (ref T value) {
		_value = ref value;
		_length = 1;
	}
	...
	/// </summary>
	public NaiveSpan (ref T[] valueArray) {
	...
	/// <summary>
	/// A copy constructor that constructs a new 'NaiveSpan' that points to the same '_value' and
	///		'_length' address as the 'NaiveSpan' to copy
	/// </summary>
	public NaiveSpan (NaiveSpan<T> naiveSpan) {
		_value = ref naiveSpan._value;
		_length = naiveSpan._length;
	}

	/// <summary>
	/// A copy constructor for System.NaiveSpan that constructs a new 'NaiveSpan'
	///		that points 'naiveSpan[0]' for '_value' and 'naiveSpan.Length' for '_length'
	/// </summary>
	public NaiveSpan (ref System.Span<T> span) {
		_value = ref span[0];
		_length = span.Length;
	}
	...
	/// </summary>
	public unsafe NaiveSpan (T* ptr, int length) {
		_value = ref *ptr;
		_length = length;
	}

	/// <summary>
	/// Gets a reference to an element of the naiveSpan
	...
	/// <summary>
	/// Returns a new 'NaiveSpan' starting at the specified offset until the end of contiguous memory
	/// Throws 'ArgumentOutOfRangeException' if offset is outside bounds
	/// </summary>
	/// <param name="offest"></param>
	/// <exception cref="ArgumentOutOfRangeException"></exception>
	public NaiveSpan<T> Slice (int offest) {
		...
		return new NaiveSpan<T>(ref Unsafe.Add(ref _value, offest), _length - offest);
	}
	...
	/// <summary>
	/// Internal constructor for manually specifying the length of the 'NaiveSpan'
	/// Thought to eliminate user error by specifying the length manually
	/// If this is required, see the unsafe constructor see 'unsafe NaiveSpan (T* ptr, int length)'
	/// </summary>
	private NaiveSpan (ref T reference, int length) {
